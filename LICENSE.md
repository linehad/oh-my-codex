...
This repository is distributed under the Sustainable Use License Version 1.0
(`SUL-1.0`).

## Upstream Attribution

- Upstream project family: oh-my-openagent / oh-my-opencode
- Upstream author: YeonGyu Kim and contributors
- Upstream source: https://github.com/code-yeongyu/oh-my-openagent/tree/dev
- Upstream package license: SUL-1.0

## Modified Copy Notice

This repository is a Codex skill adaptation. It does not include the upstream
runtime, OpenCode plugin, Team Mode tools, MCP servers, edit engine, tmux
integration, or packaged implementation code. It adapts the harness-style
agent role structure into Codex `SKILL.md` files and Codex-specific
...
of charge for non-commercial purposes. You may not alter, remove, or obscure
any licensing, copyright, or other notices of the licensor in the software. Any
...
and your license will automatically terminate.
...
your license will be reinstated retroactively. However, if you violate these
...
of it. "You" refers to the individual or entity agreeing to these terms.
...
Control can be direct or indirect. "Your license" is the license granted to you
